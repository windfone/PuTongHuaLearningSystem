...
public class PagerFragmentAdapter extends FragmentPagerAdapter {
    ...
    public PagerFragmentAdapter(FragmentManager fm, int mFrom, ArrayList<String> titles, List<OnLineLearnTitleVO> list) {
        super(fm);
        mTitles = titles;
        lists = list;
        from = mFrom;
    ...
    public Fragment getItem(int position) {
        if (from == 1){
            ...
            return ExerciseFragment.newInstance(mTitles.get(position));
        }
        return null;
    }
