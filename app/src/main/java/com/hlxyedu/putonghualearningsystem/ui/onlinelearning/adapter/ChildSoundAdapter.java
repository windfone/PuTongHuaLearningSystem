...
public class ChildSoundAdapter extends BaseQuickAdapter<PinYinBean, BaseViewHolder> {

    private List<PinYinBean> lists;
    private String title;

    public ChildSoundAdapter(int layoutResId, @Nullable List<PinYinBean> data,String mTitles) {
