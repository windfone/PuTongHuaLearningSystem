...
public class PinYinAdapter extends BaseQuickAdapter<DataVO, BaseViewHolder> {

    private String title;
    private List<DataVO> lists;

    public PinYinAdapter(int layoutResId, @Nullable List<DataVO> data, String mTitles) {
